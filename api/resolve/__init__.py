...
from ayon_server.api.dependencies import AllowExternal, ClientSiteID, CurrentUser
...
@router.post("/resolve", response_model_exclude_none=True, dependencies=[AllowExternal])
